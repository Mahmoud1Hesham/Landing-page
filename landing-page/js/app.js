...
function makeListItem () {
    for (section of sec) {
        ...
        // add an inner html code to add text html to the li item
        listItem.innerHTML = `<a class= 'menu_link'  href= '#${secLink}'>${secName}</a> `;
...
// this fuction includes a if condition to make sure that the button will appear 
